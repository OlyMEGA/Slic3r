...
sub new {
    ...
    $self->{statusbar}->SetStatusText(L("Version ").$Slic3r::VERSION.L(" - Remember to check for updates at http://github.com/OlyMEGA/slic3r/releases"));
...
sub _init_menubar {
    ...
    my $helpMenu = Wx::Menu->new;
    {
        ...
        $self->_append_menu_item($helpMenu, L("OlyMEGA Edition Releases"), L('Open the OlyMEGA Edition releases page in your browser'), sub {
            Wx::LaunchDefaultBrowser('http://github.com/OlyMEGA/slic3r/releases');
        });
...
#        $versioncheck->Enable(wxTheApp->have_version_check);
        ...
        $self->_append_menu_item($helpMenu, L("Report an Issue"), L('Report an issue on the Slic3r OlyMEGA Edition'), sub {
            Wx::LaunchDefaultBrowser('http://github.com/OlyMEGA/slic3r/issues/new');
        });
